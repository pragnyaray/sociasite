...
def user__settings(request):
    return render(request, 'settings.html')


def user__language(request):
    return render(request, 'language.html')



def user__about(request):
    return render(request, 'about.html')


def user__contact(request):
    return render(request, 'contact.html')


def user__hashtag(request):
    return render(request, 'hashtag.html')


def user__faq(request):
    return render(request, 'faq.html')


def user__terms(request):
